...
#ifndef VLPLAYER_SWIFT_H
#define VLPLAYER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VLPlayer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC8VLPlayer12MarqueeLabel")
...
SWIFT_CLASS("_TtC8VLPlayer7VLError")
...
SWIFT_CLASS("_TtC8VLPlayer8VLPlayer")
...
SWIFT_PROTOCOL("_TtP8VLPlayer21videoPlaybackDelegate_")
